...
export const USER_FORGOT_PW_FAILURE = 'USER_FORGOT_PW_FAILURE';

export const USER_RESET_PASSWORD_REQUEST = 'USER_RESET_PASSWORD_REQUEST';
export const USER_RESET_PASSWORD_SUCCESS = 'USER_RESET_PASSWORD_SUCCESS';
export const USER_RESET_PASSWORD_FAILURE = 'USER_RESET_PASSWORD_FAILURE';

export const USER_DOWNLOAD_COUNTER_REQUEST = 'USER_DOWNLOAD_COUNTER_REQUEST';
export const USER_DOWNLOAD_COUNTER_SUCCESS = 'USER_DOWNLOAD_COUNTER_SUCCESS';
export const USER_DOWNLOAD_COUNTER_FAILURE = 'USER_DOWNLOAD_COUNTER_FAILURE';
